    ...
    >
      ...
      <div className="relative flex-1 flex flex-col p-4 min-h-0">
        {isSchoolHeader && schoolName && (
          <div className="text-center mb-3 pb-2 border-b-2 flex-shrink-0" style={{ borderColor: schoolColor }}>
            <h2 
        ...
        <div className="absolute bottom-2 right-3 text-xs text-amber-900/40 font-serif">
          {pageNumber}
        </div>
      </div>
    </div>
