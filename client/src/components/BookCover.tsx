  ...
  if (type === "back") {
    return (
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, hsl(20 50% 18%), hsl(15 40% 12%))",
        }}
      >
    ...
    >
      ...
      <div className="relative h-full flex flex-col items-center justify-center px-4 sm:px-8 text-center">
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, hsl(270 60% 40% / 0.3), transparent)",
        ...
        <h1
          ...
          style={{
            color: "hsl(40 70% 65%)",
            textShadow:
              "0 2px 10px rgba(0,0,0,0.5), 0 0 30px hsl(40 70% 50% / 0.3)",
          }}
        >
          Liberus Anticqus de
        </h1>
